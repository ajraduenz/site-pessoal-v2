...
// Mudar Aqui o e-mail
$email_envio = "aldoraduenzjunior@gmail.com"; // E-mail do site (ex: contato@seusite.com)
$email_pass = "iMDYb10mPg"; // Senha do e-mail

$site_name = "Aj Raduenz"; // Nome do Site
$site_url = "ajraduenz.com"; // URL do Site

$host_smtp = "mail.ajraduenz.com"; // HOST SMTP Ex: smtp.domain.com.br
